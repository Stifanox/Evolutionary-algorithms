...
class Elitism:
    ...
    def selectEliteSpecimensPercent(howManySpecimens: float, maximize: bool,
                                    evolutionaryManger: EvolutionManager) -> None:
        """
        ...
        :param evolutionaryManger: Evolutionary manager that keep info about everything.
        :return:None
        """
        ...
        evolutionState = evolutionaryManger.getEpochSnapshot()
        ...
        evolutionaryManger.updateNewPopulation(bestSpecimens)
