...
class Selection():
    ...
    def __init__(self, fitnessFunction: FitnessFunction, selectionType: int, selectionLimitType: str, selectionLimitValue: int):
...
if __name__ == "__main__":
    ...
    Sel = Selection(FitnessFunction(),Selection.SelectionType_Top,Selection.LimitType_Constant,10)
    ...
    print("Selected",len(SpecimensSelected),"Specimens",Specimen_Values_Selected)
    print()
    ...
    Sel = Selection(FitnessFunction(),Selection.SelectionType_Roulette,Selection.LimitType_Constant,10)
    for i in range(SpecimenAmount):
        SpecToAdd = Specimen()
        Specimen_ValMin = min(Specimen_ValMin,SpecToAdd.val)
        Specimen_ValMax = max(Specimen_ValMax,SpecToAdd.val)
    ...
    Sel = Selection(FitnessFunction(),Selection.SelectionType_Tournament,Selection.LimitType_Constant,10)
    for i in range(SpecimenAmount):
        SpecToAdd = Specimen()
        Specimen_ValMin = min(Specimen_ValMin,SpecToAdd.val)
        Specimen_ValMax = max(Specimen_ValMax,SpecToAdd.val)
